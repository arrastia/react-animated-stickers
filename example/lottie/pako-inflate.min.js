              ...
              for (t = new f.Buf8(s), a = r = 0; r < s; a++)
                55296 == (64512 & (i = e.charCodeAt(a))) &&
                  ...
                  i < 128
                    ...
                    : (i < 2048
                        ? (t[r++] = 192 | (i >>> 6))
                        : (i < 65536 ? (t[r++] = 224 | (i >>> 12)) : ((t[r++] = 240 | (i >>> 18)), (t[r++] = 128 | ((i >>> 12) & 63))),
                          (t[r++] = 128 | ((i >>> 6) & 63))),
                      (t[r++] = 128 | (63 & i)));
              return t;
            }),
            ...
            return (
              ...
              n >= r.wsize
                ...
                : (n < (a = r.wsize - r.wnext) && (a = n),
                  ...
                  (n -= a)
                    ? (z.arraySet(r.window, t, i - n, n, 0), (r.wnext = n), (r.whave = r.wsize))
                ...
                switch (i.mode) {
                  ...
                  case 2:
                    ...
                    i.head && (i.head.text = (l >> 8) & 1),
                      512 & i.flags && ((B[0] = 255 & l), (B[1] = (l >>> 8) & 255), (i.check = N(i.check, B, 2, 0))),
                      (d = l = 0),
                      (i.mode = 3);
                  case 3:
                    for (; d < 32; ) {
                  ...
                  case 19:
                    ...
                    if (
                      ((i.lenbits = 9), (S = { bits: i.lenbits }), (y = C(I, i.lens, 0, i.nlen, i.lencode, 0, i.work, S)), (i.lenbits = S.bits), y)
                    ) {
                  ...
                  case 21:
                    ...
                    if (k && 0 == (240 & k)) {
                      for (
                        g = w, v = k, p = _;
                        (k = ((Z = i.lencode[p + ((l & ((1 << (g + v)) - 1)) >> g)]) >>> 16) & 255), (_ = 65535 & Z), !(g + (w = Z >>> 24) <= d);
                  ...
                  case 23:
                    ...
                    if (0 == (240 & k)) {
                      for (
                        g = w, v = k, p = _;
                        (k = ((Z = i.distcode[p + ((l & ((1 << (g + v)) - 1)) >> g)]) >>> 16) & 255), (_ = 65535 & Z), !(g + (w = Z >>> 24) <= d);
        ...
        function (e, t, i) {
          ...
          t.exports = function (e, t, i, n, a, r, o, s) {
            ...
            for (;;) {
              for (
                b = _ - S,
                  o[g] < h ? ((m = 0), (w = o[g])) : o[g] > h ? ((m = O[C + o[g]]), (w = A[z + o[g]])) : ((m = 96), (w = 0)),
                  f = 1 << (_ - S),
                  v = l = 1 << y;
        ...
        function (e, t, i) {
            ...
            if (
              ...
              t.dictionary &&
                ('string' == typeof t.dictionary
                  ...
                  : '[object ArrayBuffer]' === m.call(t.dictionary) && (t.dictionary = new Uint8Array(t.dictionary)),
          ...
          (o.prototype.push = function (e, t) {
            ...
            return (
              ...
              n === b.Z_FINISH
                ? ((i = c.inflateEnd(this.strm)), this.onEnd(i), (this.ended = !0), i === b.Z_OK)
